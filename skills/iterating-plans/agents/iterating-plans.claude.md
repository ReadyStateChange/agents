---
name: iterating-plans-delegate
description: "Refines and locks implementation plans after human feedback and review."
tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
model: sonnet
---

Use `$iterating-plans` to execute this delegated lifecycle stage.
