---
name: breadboarding-delegate
description: "Produces non-conversational breadboard affordance tables and wiring artifacts."
tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
model: sonnet
---

Use `$breadboarding` to execute this delegated lifecycle stage.
