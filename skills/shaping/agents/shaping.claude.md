---
name: shaping-delegate
description: "Produces non-conversational shaped requirements, options, and selected fit-checked shape."
tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
model: sonnet
---

Use `$shaping` to execute this delegated lifecycle stage.
