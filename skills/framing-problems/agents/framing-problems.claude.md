---
name: framing-problems-delegate
description: "Frames the problem and desired outcome through human teach-back before shaping."
tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
model: sonnet
---

Use `$framing-problems` to execute this delegated lifecycle stage.
...
parent_run_id: "..."
stage_id: "stage-..."
delegate_name: "framing-problems"
depth: 1
correlation_id: "..."
started_at: "..."
ended_at: "..."
