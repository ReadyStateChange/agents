---
name: slicing-work-delegate
description: "Cuts shaped work into vertical demoable slices with dependency ordering."
tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
model: sonnet
---

Use `$slicing-work` to execute this delegated lifecycle stage.
