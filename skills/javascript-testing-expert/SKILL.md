...
description: "Use when writing or reviewing JavaScript tests for functions or components. Focuses on robust example-based and property-based tests with Vitest, fast-check, Testing Library, browser-based visual checks, and avoiding nondeterministic tests. Does not cover black-box e2e testing."
argument-hint: "Provide the source file or component, current test setup, and the behavior or regression that needs coverage."
---
