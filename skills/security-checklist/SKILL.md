...
description: "Runs a security review against plans, code changes, or architecture decisions. Integrates with creating-plans, iterating-plans, and requesting-code-review. Use when you say: 'security check', 'review security', 'check for vulnerabilities', 'security audit'."
---
...
- During `creating-plans` — after Step 4 (Plan Structure), before writing the final plan
