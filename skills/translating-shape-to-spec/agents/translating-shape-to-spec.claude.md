---
name: translating-shape-to-spec-delegate
description: "Translates selected shape and breadboard into draft functional specification commitments."
tools: Read, Grep, Glob, LS, Edit, MultiEdit, Write, Bash
model: sonnet
---

Use `$translating-shape-to-spec` to execute this delegated lifecycle stage.
