---
name: docs-analyzer
description: The document equivalent of codebase-analyzer. Use this subagent when you need to extract the important decisions and constraints from a document.
